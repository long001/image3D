...
var urlFormat = function urlFormat(url) {
...
QuickPaper.component('uiSearch', uiSearch);
__etcpack__scope_args__=window.__etcpack__getBundle('24');
var uiFooter =__etcpack__scope_args__.default;

QuickPaper.component('uiFooter', uiFooter);
__etcpack__scope_args__=window.__etcpack__getBundle('27');
var doScroll =__etcpack__scope_args__.default;

QuickPaper.prototype.doScroll = doScroll; // 打开新页面
...
var pagename = urlFormat(window.location.href).router[0]; // 启动界面

var pages = {
  app: function app() {
    return window.__etcpack__getLazyBundle('./build/main@v0.2.7-bundle1.js','30');
  },
  core: function core() {
    return window.__etcpack__getLazyBundle('./build/main@v0.2.7-bundle2.js','31');
  },
  "opengl-es": function openglEs() {
    return window.__etcpack__getLazyBundle('./build/main@v0.2.7-bundle3.js','32');
  }
};
...
/*************************** [bundle] ****************************/
// Original file:./src/components/ui-footer.paper
/*****************************************************************/
...
__etcpack__scope_args__=window.__etcpack__getBundle('26');
    ...
    script.render=function(createElement){
        ...
        return createElement('div',{"quickpaper":"","data-quickpaper-6054e546":""},[createElement('footer',{"data-quickpaper-6054e546":""},["Copyright © 2019-2022",createElement('a',{"href":"https://hai2007.gitee.io/sweethome/","target":"_blank","data-quickpaper-6054e546":""},["hai2007 走一步，再走一步。"]),"All rights reserved.",createElement('br',{"data-quickpaper-6054e546":""},[]),"本项目由“你好2007”设计、开发和维护",createElement('a',{"href":"#/core","class":"core","target":"_blank","data-quickpaper-6054e546":""},["查看核心"])])])
...
/*************************** [bundle] ****************************/
// Original file:./src/components/ui-footer.paper?QuickPaper&type=script&lang=js&hash=6054e546
/*****************************************************************/
...
/*************************** [bundle] ****************************/
// Original file:./src/components/ui-footer.paper?QuickPaper&type=style&lang=css&hash=6054e546
/*****************************************************************/
window.__etcpack__bundleSrc__['26']=function(){
    ...
    var styleElement = document.createElement('style');
var head = document.head || document.getElementsByTagName('head')[0];
styleElement.innerHTML = "\n [quickpaper]>footer[data-quickpaper-6054e546]{\n\ntext-align: center;\n\nbackground-color: #fafafa;\n\nborder-top: 1px solid #d3d0d0;\n\nline-height: 2em;\n\npadding: 20px 0;\n\nfont-size: 14px;\n\nposition: relative;\n\n}\n\n [quickpaper]>footer>a[data-quickpaper-6054e546]{\n\npadding: 0 5px;\n\n}\n\n [quickpaper]>footer>a.core[data-quickpaper-6054e546]{\n\nposition: absolute;\n\nbottom: 36px;\n\nright: 23px;\n\nbackground: #ba642e;\n\ncolor: white;\n\ntext-decoration: underline;\n\npadding: 0 10px;\n\n}\n";
styleElement.setAttribute('type', 'text/css');head.appendChild(styleElement);
...
/*************************** [bundle] ****************************/
// Original file:./src/Service/doScroll.js
/*****************************************************************/
...
__etcpack__scope_bundle__.default= function (routername, fixedName, overValue) {
