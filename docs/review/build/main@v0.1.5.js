...
var _class = (_dec = Component({
  ...
  _createClass(_class2, [{
    ...
    value: function $mounted() {
      ...
      // 地址栏信息
      var urlObj = urlFormat(window.location.href); // 分析当前应该打开谁

      var pageName = urlObj.router[0] in pages ? urlObj.router[0] : "nav";
      window.location.href = '#/' + pageName; // 打开

      pages[pageName]().then(function (data) {
...
window.__etcpack__bundleSrc__['20']=function(){
    ...
    __etcpack__scope_bundle__.default= {
  "nav": function nav() {
    return window.__etcpack__getLazyBundle('./build/main@v0.1.5-bundle1.js','21');
  },
  "sphere-image": function sphereImage() {
    return window.__etcpack__getLazyBundle('./build/main@v0.1.5-bundle2.js','22');
  }
};
